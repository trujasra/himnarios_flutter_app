...
class _FavoritoScreenState extends State<FavoritoScreen> with RouteAwareMixin {
  ...
  Widget _buildCollapsibleSection(String nombreHimnario, List<Cancion> cancionesDelHimnario) {
  ...
  Widget build(BuildContext context) {
    ...
    var cancionesFavoritas = canciones.where((c) => favoritos.contains(c.id)).toList();
    
    // Si hay filtro de himnario, aplicarlo
    if (widget.himnarioFiltro != null) {
      cancionesFavoritas = cancionesFavoritas.where((c) => c.himnario == widget.himnarioFiltro).toList();
    }
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          widget.himnarioFiltro != null ? 'Favoritos - ${widget.himnarioFiltro}' : 'Favoritos',
                        ...
                        children: [
                          if (widget.himnarioFiltro == null) ...[
                            ...
                            ...favoritosPorHimnario.entries.map((entry) {
                              ...
                              return _buildCollapsibleSection(nombreHimnario, cancionesDelHimnario);
                            }),
                          ] else ...[
